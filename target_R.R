...
rm(ids, pi_name, projects_clean, projects_clean_2)
...
coef_df_int <- bind_rows(coefs_qr_int, coef_gr_int) |> 
  mutate(term = case_when(
    ...
    term == 'log_seniority_mc' ~ 'ln(Seniority)',
...
rm(m_gr, coef_df_naiv, p_ts_ci, m_gr_cont, coef_df_cont, p_ts_ci_cont, m_gr_int, m10, m50, m90, tidy_m10, tidy_m50, tidy_m90, p_ts_ci_all, p_ts_ci_all_clean, pre, coef_df_int, coef_gr_cont, coef_gr_int, coefs_gr, coefs_qr, coefs_qr_cont, coefs_qr_int, m_qrs, m_qrs_cont, m_qrs_int, p_ts_ci_control, p_ts_ci_int, p_ts_ci_interact, pval_gr_cont, pval_gr_int, se_gr, se_gr_cont, se_gr_int, se_qr, se_qr_cont, se_qr_int, coef_df)
...
rm(coefs_gr_tmx, coefs_gr_tx, coefs_qr_tmx, coefs_qr_tx, coefs_tx, coefs_txm, m_gr_tmx, m_gr_tx, m_qrs_tmx, m_qrs_tx, m1, m2, m3, m4, m5, m6, m7, m8, p_m, p1, p2, se_gr_tmx, se_gr_tx, se_qr_tmx, se_qr_tx, x_ax)
}
